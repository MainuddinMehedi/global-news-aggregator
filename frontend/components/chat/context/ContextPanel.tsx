...
export default function ContextPanel({
  ...
  const isMobileOpen = forceState === "open";
  const isDesktopOpen = forceState !== "closed"; // open by default

  return (
    <div
      className={cn(
        "flex absolute right-0 z-30 lg:relative shrink-0 h-[80vh] max-h-[700px] self-center transition-all duration-300 ease-in-out",
        // Mobile logic
        isMobileOpen ? "w-[calc(100vw-2rem)] max-w-80 mr-4" : "w-7 mr-0",
        // Desktop logic
        isDesktopOpen ? "lg:w-80 lg:mr-4" : "lg:w-7 lg:mr-4"
      )}
    >
      <div
        className={cn(
          "w-[calc(100vw-2rem)] max-w-80 flex flex-col rounded-2xl border border-border bg-background overflow-hidden shadow-sm h-full transition-all duration-300 ease-in-out origin-right absolute right-0 inset-y-0",
          // Mobile logic
          isMobileOpen
          ...
          // Desktop logic
          isDesktopOpen
            ? "lg:opacity-100 lg:scale-100 lg:translate-x-0 lg:pointer-events-auto"
            : "lg:opacity-0 lg:scale-95 lg:translate-x-4 lg:pointer-events-none"
        )}
      >
      ...
      <button
        ...
        className={cn(
          ...
          isDesktopOpen
            ...
            : "lg:opacity-0 lg:scale-75 lg:pointer-events-none"
        )}
      >
        <HugeiconsIcon
      ...
      <button
        ...
        className={cn(
          ...
          // Desktop logic
          isDesktopOpen
            ? "lg:opacity-0 lg:scale-90 lg:translate-x-4 lg:pointer-events-none"
            : "lg:opacity-100 lg:scale-100 lg:translate-x-0 lg:pointer-events-auto"
        )}
      >
        <HugeiconsIcon
