    ...
    <div className="space-y-6">
      <div className="space-y-4">
        <div className="space-y-2">
          <Label htmlFor="displayName" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/70">Display Name</Label>
          <Input 
            id="displayName"
        ...
        <div className="space-y-2">
          <Label htmlFor="userContext" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/70">What do you want to track?</Label>
          <Textarea 
            id="userContext"
          ...
          <p className="text-xs text-muted-foreground leading-relaxed italic">
            Describe your intent in detail. Our AI will analyze this to generate optimized search queries and identify relevant sources.
          </p>
        </div>
      </div>
