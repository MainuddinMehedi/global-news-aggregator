...
export default function LockedTopicGrid({ topics, latestFindingsMap }: LockedTopicGridProps) {
  if (topics.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center space-y-6">
        ...
        <div className="space-y-2">
          <h3 className="text-2xl font-bold tracking-tight">No locked topics yet</h3>
          <p className="text-muted-foreground max-w-sm mx-auto leading-relaxed">
            Create persistent trackers for specific investigative themes, career opportunities, or geopolitical events.
          </p>
        </div>
        <CreateTopicModal 
          trigger={
            <Button size="lg" className="gap-2 rounded-full px-8 shadow-lg shadow-primary/20 hover:scale-105 transition-transform">
