...
- [[enrichment-pipeline md doc audit by me]] — _User manual audit notes detailing conceptual critiques of sourceOrigin and model naming._
...
- **Stage 2 (Python FastAPI):** Runs a Python FastAPI microservice (currently hosting GLiNER and VADER Sentiment Analyzer) over HTTP to perform named entity extraction and calculate compound sentiment.
...
graph TD
    ...
    C -->|Yes| E[Stage 2: Python FastAPI Microservice]
    E -->|GLiNER NER & VADER Sentiment| F[Merge Metadata Fields]
...
- [stage2.js](file:///home/mainu/programming/projects/automation/geopolitical-news-monitor/global-news-aggregator/ingestion-service/ai/stage2.js) — Client connector sending batches to the FastAPI microservice.
- [main.py](file:///home/mainu/programming/projects/automation/geopolitical-news-monitor/global-news-aggregator/enrichment-service/main.py) — Python FastAPI endpoint running GLiNER and VADER.
