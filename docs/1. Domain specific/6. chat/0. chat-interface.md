...
| File | Directive | Role |
|------|-----------|------|
| [page.tsx](file:///home/mainu/programming/projects/automation/geopolitical-news-monitor/global-news-aggregator/frontend/app/chat/page.tsx) | Server Component | Thin shell — wrapped in `<Suspense>` for client searchParams sync |
| [ChatInterface.tsx](file:///home/mainu/programming/projects/automation/geopolitical-news-monitor/global-news-aggregator/frontend/components/chat/ChatInterface.tsx) | `"use client"` | Orchestrator — orchestrates UI elements, triggers send / AI response |
| [ChatHeader.tsx](file:///home/mainu/programming/projects/automation/geopolitical-news-monitor/global-news-aggregator/frontend/components/chat/ChatHeader.tsx) | `"use client"` | Floating header pills — Analyst badge, New Chat trigger, history sheet trigger |
| [ChatInput.tsx](file:///home/mainu/programming/projects/automation/geopolitical-news-monitor/global-news-aggregator/frontend/components/chat/ChatInput.tsx) | `"use client"` | Input bar — textarea, send, voice toggle, models config |
| [MessageList.tsx](file:///home/mainu/programming/projects/automation/geopolitical-news-monitor/global-news-aggregator/frontend/components/chat/MessageList.tsx) | No directive | Pure display list — renders `MessageBubble` instances |
| [MessageBubble.tsx](file:///home/mainu/programming/projects/automation/geopolitical-news-monitor/global-news-aggregator/frontend/components/chat/MessageBubble.tsx) | `"use client"` | Individual message block — handles thoughts, logs, citations |
| [CitationsStrip.tsx](file:///home/mainu/programming/projects/automation/geopolitical-news-monitor/global-news-aggregator/frontend/components/chat/CitationsStrip.tsx) | `"use client"` | Citations bar — extracts and formats message URL/doc citations |
| [ContextPanel.tsx](file:///home/mainu/programming/projects/automation/geopolitical-news-monitor/global-news-aggregator/frontend/components/chat/ContextPanel.tsx) | `"use client"` | Desktop sidebar + `ContextPills` (mobile) — context management UI |
| [VoiceSession.tsx](file:///home/mainu/programming/projects/automation/geopolitical-news-monitor/global-news-aggregator/frontend/components/chat/VoiceSession.tsx) | `"use client"` | Full-screen overlay — waveform visualizer, mic control, transcript |
| [useChatSessions.ts](file:///home/mainu/programming/projects/automation/geopolitical-news-monitor/global-news-aggregator/frontend/hooks/useChatSessions.ts) | `"use client"` | React hook — encapsulates session history operations and derived URL state |
| [useChatContext.ts](file:///home/mainu/programming/projects/automation/geopolitical-news-monitor/global-news-aggregator/frontend/hooks/useChatContext.ts) | `"use client"` | React hook — manages selected context items state |
| [messageCitations.ts](file:///home/mainu/programming/projects/automation/geopolitical-news-monitor/global-news-aggregator/frontend/lib/chat/messageCitations.ts) | N/A | Citations library — parses AI tool outputs and resource parts |
| [messages.ts](file:///home/mainu/programming/projects/automation/geopolitical-news-monitor/global-news-aggregator/frontend/lib/chat/messages.ts) | N/A | Message & comparison utilities — contains text parsing and renderability check helpers |
| [errors.ts](file:///home/mainu/programming/projects/automation/geopolitical-news-monitor/global-news-aggregator/frontend/lib/chat/errors.ts) | N/A | Error normalization — sanitizes and parses API/DB errors |

### Component Tree

```mermaid
graph TD
    A["app/chat/page.tsx<br/><em>Server Component (Suspended)</em>"] --> B["ChatInterface<br/><em>'use client' — orchestrator</em>"]
    B --> C["ChatHeader<br/><em>'use client' — top bar & history</em>"]
    B --> D["MessageList<br/><em>Pure display (no directive)</em>"]
    D --> D1["MessageBubble<br/><em>'use client'</em>"]
    D1 --> D2["CitationsStrip<br/><em>'use client' — source citations</em>"]
    B --> E["ChatInput<br/><em>'use client'</em>"]
    B --> F["VoiceSession<br/><em>'use client'</em>"]
    B --> G["ContextPanel<br/><em>'use client'</em>"]
    E --> H["ContextPills<br/><em>slot prop from ContextPanel</em>"]
    B --> I["useChatSessions<br/><em>hook — state sync & history</em>"]
    B --> J["useChatContext<br/><em>hook — context items state</em>"]
    
    style A fill:#2d4a3e,stroke:#4ade80,color:#fff
    style B fill:#3b3a5c,stroke:#a78bfa,color:#fff
    style C fill:#3b3a5c,stroke:#a78bfa,color:#fff
    style D fill:#2d4a3e,stroke:#4ade80,color:#fff
    style D1 fill:#3b3a5c,stroke:#a78bfa,color:#fff
    style D2 fill:#3b3a5c,stroke:#a78bfa,color:#fff
    ...
    style H fill:#3b3a5c,stroke:#a78bfa,color:#fff
    style I fill:#4b5563,stroke:#9ca3af,color:#fff
    style J fill:#4b5563,stroke:#9ca3af,color:#fff
```
