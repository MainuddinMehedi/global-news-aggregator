...
Evaluate every engineering candidate against these core architectural vectors, actively trying to _disprove_ why an option might fail, choke, or drift under our specific long-term conditions:
...
- **Prose Over Raw Diffs:** Explain implementation plans, new features, or structural code modifications in clear, conceptual prose _before_ or alongside showing code changes. Reduce cognitive load by mapping out _how_ the system behaves conceptually.
